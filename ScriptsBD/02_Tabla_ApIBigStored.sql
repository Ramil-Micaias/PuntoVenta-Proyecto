...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'EstadoOrden')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'OrdenReparacion')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'DetalleOrdenRepuesto')
BEGIN
